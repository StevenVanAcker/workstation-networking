...
def generate_config_file(currenthostname: str, data: dict):
    ...
    if hostname != currenthostname:
        print(f"Skipping WireGuard profile '{name}': "
              f"hostname mismatch '{hostname}' <> '{currenthostname}'")
        return None, None
...
def generate_config(name: str, optstr: str, currenthostname: str,
